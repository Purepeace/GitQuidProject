...
#
#     response = render(request, 'GitQuid/index.html', context=context_dict)
#     return response
#
#
# # A helper method
...
#                 # We'll send the user back to the homeproject.
#                 login(request, user)
#                 return HttpResponseRedirect(reverse('index'))
#             else:
#                 # An inactive account was used - no logging in!
#                 return HttpResponse("Your GitQuid account is disabled.")
#         else:
...
#         return render(request, 'GitQuid/login.html', {})
#
#
# @login_required
# def retricted(request):
#     return render(request, 'GitQuid/restricted.html', {})
#
#
